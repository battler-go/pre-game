        ...
        <div class="container">
          ...
          <div class="card col m5 brown lighten-1 quitar-padding-lateral">
            ...
            <div class="card-image">
              <img src="https://s3.amazonaws.com/gameartpartnersimagehost/wp-content/uploads/2016/06/Chibi-Samurai-Royalty-Free-Game-Art-Featured.png">
            </div>
            ...
            <div class="card-content grey lighten-2">
              ...
              <!-- Salud -->
              <i class="fa fa-heartbeat"></i> <span class="right">{{saludUsuario}}/100</span>
              <div class="progress brown">
                <div class="determinate red" v-bind:style="{width: saludUsuario + '%'}"></div>
              </div>

              <!-- Mana -->
              <i class="fa fa-magic"></i> <span class="right">{{manaUsuario}}/100</span>
              <div class="progress brown">
            ...
            <div class="card-action barra-ataques brown darken-3">
              <a class="btn-floating red" @click="normal"><i class="fa fa-gavel"></i></a>
              <a v-bind:class="[manaUsuario < '10' ? 'disabled' : 'blue', 'btn-floating']" @click="especial"><i class="fa fa-magic"></i></a>
              <a v-bind:class="[manaUsuario < '15' ? 'disabled' : 'green', 'btn-floating']" @click="curar"><i class="fa fa-medkit"></i></a>
              <a class="btn-floating grey" @click="rendirse"><i class="fa fa-flag"></i></a>
            </div>
          </div>
          ...
          <div class="card col offset-m2 m5 brown lighten-1 quitar-padding-lateral">
            ...
            <!-- Avatar -->
            <div class="card-image">
              <img src="https://gameartpartners.com/wp-content/uploads/edd/2015/03/Darkness_Knight_Featured.png" class="girar-imagen">
            </div>
            ...
            <div class="card-content grey lighten-2">
              ...
              <!-- Salud -->
              <i class="fa fa-heartbeat"></i> <span class="right">{{saludEnemigo}}/100</span>
              <div class="progress brown">
                <div class="determinate red" v-bind:style="{width: saludEnemigo + '%'}"></div>
              </div>

              <!-- Mana -->
              <i class="fa fa-magic"></i> <span class="right">{{manaEnemigo}}/100</span>
              <div class="progress brown">
